...
@UseTestDataFrom("src/test/resources/Superliga22_23TopScorerValidData.csv")
public class Superliga22_23TopScorerFilterByTeamValidData {
    ...
    public void testValidTopScorer(){
        ...
        superliga2223TopScorerSteps.selectsTeam(getEchipa());
        superliga2223TopScorerSteps.checksTopScorerName(getTop_marcator());
    }
}
